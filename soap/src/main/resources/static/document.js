...
function listDocumentSoap(){
    ...
    var sr = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:gen="com/itrail/soap/generated/documents">' +
            '   <soapenv:Header/> ' +
            '     <soapenv:Body> ' +
...
function findByIdDocument(){
    $(document.getElementById("findById")).on( "click",function(){
        ...
        let xhr = new XMLHttpRequest();
        xhr.open('POST', 'https://localhost:8088/ws' );
        sr = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:gen="com/itrail/soap/generated/documents">'+
            '   <soapenv:Header/>'+
            '   <soapenv:Body>'+
